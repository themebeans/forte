...
class Bean_Flickr_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'bean_flickr', // Base ID
			__( 'Flickr Photos', 'forte' ), // Name
			array( 'description' => __( 'Add a Flickr feed widget.', 'forte' ) ) // Args
		);
	}
...
<p><?php echo balanceTags( $desc ); ?></p><?php endif; ?>
	...
	function form( $instance ) {
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Title / Intro:', 'forte' ); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'flickrID' ) ); ?>"><?php _e( 'Flickr ID:', 'forte' ); ?> (<a target="_blank" href="http://idgettr.com/">idGettr</a>)</label>
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>"><?php _e( 'Type:', 'forte' ); ?></label>
...
>Group</option>
		...
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'display' ) ); ?>"><?php _e( 'Display:', 'forte' ); ?></label>
